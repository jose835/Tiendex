      ...
      <main className="border border-gray-300 shadow-sm rounded-lg">
        <section className="flex bg-white rounded-t-lg items-center justify-between py-10 px-32">
          <div className="w-1/2">
            ...
            <p className={`${FONTS.subtitle} mt-2 w-full`}>Comience por abastecer su tienda con productos que a sus clientes les encantarán</p>
            <div className="mt-5">
        ...
        <footer className="bg-[#f7f7f7] w-full rounded-b-lg px-32 py4 h-32 flex flex-col justify-center">
          ...
          <p className={`${FONTS.subtitle} text-xs max-w-[70%]  mt-2 w-full`}>Haga que los productos de envío directo o impresión bajo demanda se envíen directamente desde el proveedor a su cliente, y pague solo por lo que vende.</p>
        </footer>
      </main>
